...
$(document).ready(function(){
    ...
    $('.order_btn').click(function(){
        ...
        var titltle = $(this).parents(".d-flex").siblings(".d-flex").find(".card-title").text();
        ...
        var cart_item =`<div class="main d-flex p-3 border border-left-0 border-right-0 border-top-0"> 
                            ...
                            <div id="title" class="col-md-3 d-flex flex-wrap align-content-center">             
                               <h6 style="font-size:13px;">${titltle}</h6>        
                            </div>        
